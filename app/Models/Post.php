...
class Post extends Model
{
    ...
    public function categoryPost(){
        return $this->hasMany(CategoryPost::class); //category_post table
    }
    ...
    /**
     * Use this method to get all the likes of a post
     */
     ...
     */
     ...
     # Will return TRUE if the AUTH USER already liked  the post
